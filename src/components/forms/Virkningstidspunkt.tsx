            ...
            <form>
                <div className="grid gap-y-4 mt-4">
                    <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        <Select label="Søknadstype" className="w-52">
                        ...
                        <Select label="Søknad fra" className="w-52">
                            <option value="BM">BM</option>
                            <option value="BP">BP</option>
                        </Select>
                        <UNSAFE_DatePicker {...datepickerProps}>
                            <UNSAFE_DatePicker.Input {...inputProps} label="Mottat dato" />
                        </UNSAFE_DatePicker>
                        <UNSAFE_DatePicker {...datepickerProps}>
                            <UNSAFE_DatePicker.Input {...inputProps} label="Søkt fra dato" />
                        </UNSAFE_DatePicker>
                    </div>
                    <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
                        <UNSAFE_DatePicker {...datepickerProps}>
                            <UNSAFE_DatePicker.Input {...inputProps} label="Virkningstidspunkt" />
                        </UNSAFE_DatePicker>
                        <Select label="Årsak" className="w-52">
                            <option value="aarsak_1">Årsak 1</option>
                            <option value="aarsak_2">Årsak 2</option>
                        </Select>
                        <Select label="Avslag/opphør" className="w-52">
                    ...
                    <Button loading={false} onClick={onNext} className="w-max">
                        Gå videre
                    </Button>
                </div>
            </form>
