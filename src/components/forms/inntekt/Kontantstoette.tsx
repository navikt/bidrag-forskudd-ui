...
export const KontantstøtteTabel = ({ barn }: { barn: RolleDto }) => {
    ...
    const fieldName = `kontantstøtte.${barn.ident}` as const;
    ...
    return (
        <>
            {errors?.kontantstøtte?.[barn.ident]?.types?.overlappingPerioder && (
                <Alert variant="warning">
                    <BodyShort>{errors.kontantstøtte[barn.ident].types.overlappingPerioder}</BodyShort>
                </Alert>
            )}
