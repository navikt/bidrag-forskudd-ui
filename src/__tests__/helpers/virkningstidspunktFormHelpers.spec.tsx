...
describe("VirkningstidspunktFormHelpers", () => {
    ...
    it("getFomAndTomForMonthPicker should set fom to first day of current month of virkningstidspunkt and tom to last day of virkningstidspunkt month if virkningstidspunkt is in future", () => {
        const virkningsDato = addMonths(new Date(), 3);
        const [fom, tom] = getFomAndTomForMonthPicker(virkningsDato);
        expect(fom.toLocaleDateString()).equals(firstDayOfMonth(new Date()).toLocaleDateString());
