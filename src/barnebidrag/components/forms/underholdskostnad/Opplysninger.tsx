            ...
            <Table className="w-[350px] opplysninger" size="small">
                <Table.Header>
                    <Table.Row>
                        ...
                        <Table.HeaderCell>{text.label.stønadTilBarnetilsyn}</Table.HeaderCell>
                        <Table.HeaderCell>{text.label.omfang}</Table.HeaderCell>
                    </Table.Row>
                </Table.Header>
                <Table.Body>
                    {perioder.map((periode, index) => (
                        <Table.Row key={`${periode.partPersonId}-${index}`}>
